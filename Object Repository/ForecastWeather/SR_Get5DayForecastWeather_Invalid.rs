...
<WebServiceRequestEntity>
   ...
   <name>SR_Get5DayForecastWeather_Invalid</name>
   <tag></tag>
   <elementGuidId>fd17882d-aedb-47b5-9259-a4f1a29ad915</elementGuidId>
   ...
   <restUrl>https://api.openweathermap.org/data/2.5/frcst?lat=${lat}&amp;lon=${lon}&amp;appid=${apiKey}</restUrl>
