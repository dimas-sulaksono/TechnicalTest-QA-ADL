...
<WebServiceRequestEntity>
   ...
   <name>SR_GetCurrentAirPollution_Invalid</name>
   <tag></tag>
   <elementGuidId>bc94926a-ae33-4614-9cbf-d38d233137f9</elementGuidId>
   ...
   <restUrl>http://api.openweathermap.org/data/2.5/pollution?lat=${lat}&amp;lon=${lon}&amp;appid=${apiKey}</restUrl>
